...
set output "set-ravl-1m-cervino.eps"
...
plot \
    '../data/cervino/set-ravl-1m-tl2orig.txt'       using 1:($2/1e6) with linespoints notitle ls 1  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-tiny.txt'          using 1:($2/1e6) with linespoints notitle ls 3  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-tlrweager.txt'     using 1:($2/1e6) with linespoints notitle ls 4  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-oreceager.txt'     using 1:($2/1e6) with linespoints notitle ls 5  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-ofwf.txt'          using 1:($2/1e6) with linespoints notitle ls 7  lw 3 dt (1,1), \
...
plot \
    ...
    '../data/cervino/set-ravl-1m-tiny.txt'          using 1:($3/1e6) with linespoints notitle ls 3  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-tlrweager.txt'     using 1:($3/1e6) with linespoints notitle ls 4  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-oreceager.txt'     using 1:($3/1e6) with linespoints notitle ls 5  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-ofwf.txt'          using 1:($3/1e6) with linespoints notitle ls 7  lw 3 dt (1,1), \
...
set yrange [0:60]
set style textbox opaque noborder fillcolor rgb "white"
set label at first 1,60 front boxed left offset -0.5,0 "60" font "Helvetica Condensed"
set label at graph 0.5,1.075 center font "Helvetica-bold Condensed,18" "i=0% r=0% l=100%"

plot \
    '../data/cervino/set-ravl-1m-tl2orig.txt'       using 1:($4/1e6) with linespoints notitle ls 1  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-tiny.txt'          using 1:($4/1e6) with linespoints notitle ls 3  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-tlrweager.txt'     using 1:($4/1e6) with linespoints notitle ls 4  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-oreceager.txt'     using 1:($4/1e6) with linespoints notitle ls 5  lw 3 dt (1,1), \
    '../data/cervino/set-ravl-1m-ofwf.txt'          using 1:($4/1e6) with linespoints notitle ls 7  lw 3 dt (1,1), \
...
set object 1 rect from screen 0.68,0.41 to screen 0.82,0.43
set object 1 rect fc rgb 'white' fillstyle solid 1.0 noborder
set object 2 rect from screen 0.68,0.35 to screen 0.82,0.37
set object 2 rect fc rgb 'white' fillstyle solid 1.0 noborder

set key at screen 0.83,0.465 samplen 2.0 font "Helvetica Condensed,18" noinvert width 1 spacing 0.95
plot [][0:1] \
