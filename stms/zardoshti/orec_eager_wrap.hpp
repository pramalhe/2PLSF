...
#include <cassert>
// This is a wrapper to Orec Eager, taken from the github repository:
...
#include "../zardoshti/common/undolog_atomic.h"
#include "../zardoshti/stm_algs/orec_eager.h"



namespace orec_eager {
...
public:
    ...
    struct tmbase : public orec_eager::tmbase { };

    static std::string className() { return "orec_eager"; }
