...
// This is a wrapper to Orec Lazy, taken from the github repository:
...
#include "../zardoshti/stm_algs/orec_lazy.h"
...
typedef OrecLazy<OrecTable<NUM_STRIPES, OREC_COVERAGE, CounterTimesource>,
...
public:
    ...
    struct tmbase : public orec_lazy::tmbase { };

    static std::string className() { return "orec_lazy"; }
...
typename OrecLazy<O, R, E, C, S, A>::Globals
    OrecLazy<O, R, E, C, S, A>::globals;
