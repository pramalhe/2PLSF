...
// This is a wrapper to TLRW taken from the github repository:
...
#include "../zardoshti/stm_algs/tlrw_eager.h"



namespace tlrw_eager {
...
public:
    ...
    struct tmbase : public tlrw_eager::tmbase { };

    static std::string className() { return "tlrw_eager"; }
