...
class TMHashMapFixedSize : public TM::tmbase {
...
public:
    ...
    // The default size is hard-coded to 10000 entries in the buckets array
    TMHashMapFixedSize(int capa=10000) {
        TM::template updateTx<bool>([=] () {
            capacity = capa;
            buckets = (TMTYPE<Node*>*)TM::tmMalloc(capacity*sizeof(TMTYPE<Node*>));
