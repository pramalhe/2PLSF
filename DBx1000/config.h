...
// Concurrency Control
/***********************************************/
// WAIT_DIE, NO_WAIT, DL_DETECT, TIMESTAMP, MVCC, HEKATON, HSTORE, OCC, VLL, TICTOC, SILO, TWO_PL_SF
// TODO TIMESTAMP does not work at this moment
#define CC_ALG                      TWO_PL_SF
...
#define ABORT_PENALTY 				100000  // default is 100k
#define ABORT_BUFFER_SIZE			10
#define ABORT_BUFFER_ENABLE			false   // default is true
// [ INDEX ]
...
#define MAX_TXN_PER_PART 			100000 // default is 100k
#define FIRST_PART_LOCAL 			true
#define MAX_TUPLE_SIZE				1024 // in bytes
// ==== [YCSB] ====
#define INIT_PARALLELISM			1
#define SYNTH_TABLE_SIZE 			(1024 * 1024 * 10)  // default is 10M
